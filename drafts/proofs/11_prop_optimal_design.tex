...
The ``planner'' refers to a social planner who chooses the anthropomorphic signal $x$ to maximize welfare, taking equilibrium behavior as given. This is a first-best benchmark; designer incentives and second-best regulation are discussed in Remark~\ref{rem:decision-maker}.
...
Under Example~\ref{ex:linear-attribution}, human $i$'s attributed expectation of AI $j$'s expectation is:
